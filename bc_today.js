...
//Makes a variable for this line of code to have a date.
var thisDate = new Date();

// Sets dateString to thisDate.
var dateString = thisDate.toLocaleString();

//Makes a variable to dateHTML and also makes it to have a string to the h2 element. 
var dateHTML = "<h2>" + dateString + "</h2>";

//This line of code gets the day from the thisDate variable
var thisDay = thisDate.getDay();

//This line of code sets the eventHTML to the function with a parameter of the day.
